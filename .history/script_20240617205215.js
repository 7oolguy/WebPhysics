...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const addOpenBtn = document.getElementById("add");
  const addCloseBtn = document.getElementById("closeBtn-add");

  if (addOpenBtn) {
    openBtn.addEventListener("click", function () {
      const floatingTab = document.getElementById("add-floatingTab");
      floatingTab.style.display = "block";
    });
  } else {
    console.error("Element with ID 'config' not found");
  ...
  function makeAddTabDraggable() {
    const floatingTab = document.getElementById("add-floatingTab");
    const tabHeader = document.getElementById("add-tabHeader");
