...
function defaultData(){
  const airDensity = airDensity(25, 60);
...
function getParam () {
  ...
  document.getElementById('gravity').addEventListener('submit', () => {

  });

  document.getElementById('atmosphere').addEventListener('submit', () => {
...
document.getElementById('submit-config').addEventListener('click', () => {
  document.getElementById('atmosphere').submit;
  document.getElementById('gravity').submit;
